...
## <a name="Java"></a>Java
   ...
   - [Petersoj/alpaca-java](https://github.com/Petersoj/alpaca-java) - A Java library for the Alpaca brokerage platform providing access to stocks, options, crypto trading, and more (https://alpaca.markets)
