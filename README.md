...
## <a name="C"></a>C
   ...
   - [invariant-hq/mosaic](https://github.com/invariant-hq/mosaic) - Terminal user interfaces for OCaml.
...
## <a name="Clojure"></a>Clojure
   ...
   - [redplanetlabs/agent-o-rama](https://github.com/redplanetlabs/agent-o-rama) - End-to-end platform for building and perfecting LLM agents on the JVM
   ...
   - [motherduckdb/metabase_duckdb_driver](https://github.com/motherduckdb/metabase_duckdb_driver) - Metabase DuckDB Driver shipped as 3rd party plugin
...
## <a name="Go"></a>Go
   ...
   - [go-kratos/blades](https://github.com/go-kratos/blades) - Blades is a Go-based multimodal AI Agent framework.
   ...
   - [Tochemey/goakt](https://github.com/Tochemey/goakt) - [Go]Distributed Actor/Grain framework for Golang with goodies
   ...
   - [leomorpho/goship](https://github.com/leomorpho/goship) - Opinionated Go + HTMX framework for shipping production apps fast ⛵️
   ...
   - [cinar/indicator](https://github.com/cinar/indicator) - High-performance technical analysis indicators and backtesting framework in Go. Zero dependencies. ✨ See how! 👀
   ...
   - [sortie-ai/sortie](https://github.com/sortie-ai/sortie) - Turn tracker tickets into autonomous agent sessions
   ...
   - [webhookx-io/webhookx](https://github.com/webhookx-io/webhookx) - The Next-Generation Webhooks Gateway.
...
## <a name="Java"></a>Java
   ...
   - [Petersoj/alpaca-java](https://github.com/Petersoj/alpaca-java) - A Java library for the Alpaca brokerage platform providing access to stocks, options, crypto trading, and more.
   ...
   - [cel-expr/cel-java](https://github.com/cel-expr/cel-java) - Fast, portable, non-Turing complete expression evaluation with gradual typing (Java)
   ...
   - [FasterXML/jackson-module-jsonSchema](https://github.com/FasterXML/jackson-module-jsonSchema) - (DEPRECATED for Jackson 3) Module for generating JSON Schema (v3) definitions from POJOs
   - [gregory-ledenev/java-class-extension](https://github.com/gregory-ledenev/java-class-extension) - A powerful library that emulates class extensions (categories) in Java. In addition it supports interfaces and objects composition, interfaces adoption, object unions and aspects.  
   ...
   - [littlehorse-enterprises/littlehorse](https://github.com/littlehorse-enterprises/littlehorse) - LittleHorse Server: Workflow Engine for Microservice Orchestration &amp; Business-as-Code, and the core of the Saddle Command Center
   ...
   - [siy/pragmatica-lite](https://github.com/siy/pragmatica-lite) - Modern Functional Programming for Java 25
   ...
   - [gizmodata/quack-jdbc](https://github.com/gizmodata/quack-jdbc) - JDBC driver for DuckDB&apos;s Quack remote protocol (quack:// URI scheme). Lets any JVM tool query a remote DuckDB server over HTTP.
...
## <a name="Kotlin"></a>Kotlin
   ...
   - [KStateMachine/kstatemachine](https://github.com/KStateMachine/kstatemachine) - A powerful Kotlin Multiplatform state machine library with clean DSL syntax and first-class Kotlin Coroutines support
   - [andrewoma/kwery](https://github.com/andrewoma/kwery) - Kwery is an SQL library for Kotlin
   - [namastack/namastack-outbox](https://github.com/namastack/namastack-outbox) - Outbox Implementation for Spring Boot
...
## <a name="Not%20Set"></a>Not Set
   ...
   - [nvartolomei/oswald](https://github.com/nvartolomei/oswald) - A Write-Ahead Log (WAL) design built exclusively on object storage primitives.
   ...
   - [Aracki/toolnetes](https://github.com/Aracki/toolnetes) - 🔧 Collection of miscellaneous Kubernetes tools.
   - [worcr/worcr](https://github.com/worcr/worcr) - Next-gen background job processing 🏭
   - [paulosuzart/zart-skills](https://github.com/paulosuzart/zart-skills) - Skills used for Agentic Engineering at Zart
...
## <a name="OCaml"></a>OCaml
   ...
   - [leostera/riot](https://github.com/leostera/riot) - There are many OCaml stacks, this one is mine.
...
## <a name="Python"></a>Python
   ...
   - [HKUDS/OpenPhone](https://github.com/HKUDS/OpenPhone) - [ACL 2026] &quot;OpenPhone: Mobile Agentic Foundation Models for AI Phone&quot;
   ...
   - [smart-models/Sentences-Chunker](https://github.com/smart-models/Sentences-Chunker) - Cutting-edge tool designed to intelligently segment text documents into optimally-sized chunks
   ...
   - [coding-kitties/investing-algorithm-framework](https://github.com/coding-kitties/investing-algorithm-framework) - Framework for quantitative trading. Complete framework for development, backtesting, and deploying automated trading algorithms and trading bots.
   ...
   - [chirpz-ai/pandaprobe](https://github.com/chirpz-ai/pandaprobe) - open source agent engineering platform: traces, evals, and metrics to debug and improve your AI agents. Integrates with LangGraph, CrewAI, Claude Agent SDK, and more. 
   ...
   - [MotleyAI/slayer](https://github.com/MotleyAI/slayer) - An embeddable, expressive semantic layer for AI agents and humans — by Motley
...
## <a name="Rust"></a>Rust
   ...
   - [0xSero/Azul](https://github.com/0xSero/Azul) - Browse the world in the comfort of your terminal
   ...
   - [9j/claude-code-mux](https://github.com/9j/claude-code-mux) - High-performance AI routing proxy built in Rust with automatic failover, priority-based routing, and    support for 15+ providers (Anthropic, OpenAI, Cerebras, Minimax, Kimi, etc.)
   ...
   - [iopsystems/durable](https://github.com/iopsystems/durable) - A durable execution engine for rust 
   ...
   - [raphaelmansuy/edgeparse](https://github.com/raphaelmansuy/edgeparse) - EdgeParse converts any digital PDF into Markdown, JSON (with bounding boxes), HTML, or plain text — deterministically, without a JVM, without a GPU, and with best-in-class accuracy on the 200-document benchmark suite included in this repository.
   ...
   - [hosmelq/ext-anydoc](https://github.com/hosmelq/ext-anydoc) - PHP extension for converting documents to GitHub-Flavored Markdown with Firecrawl anydoc
   ...
   - [majiayu000/harness](https://github.com/majiayu000/harness) - Run fleets of parallel coding agents with governance — Rust control plane for Claude Code &amp; Codex: orchestration, policy, cross-agent review, observability.
   ...
   - [lakekeeper/lakekeeper](https://github.com/lakekeeper/lakekeeper) - Apache Iceberg REST Catalog in Rust — access control, credential vending and audit for every engine and AI agent. Apache 2.0.
   ...
   - [subramanya1997/markdownfs](https://github.com/subramanya1997/markdownfs) - A high-performance, in-memory virtual file system for Markdown files. Unix-like commands, Git-style versioning, content-addressable storage, and multi-user permissions — built in Rust.
   ...
   - [nurmohammed840/nio](https://github.com/nurmohammed840/nio) - Thread-Per-Core async runtime for Rust
   ...
   - [eboody/statum](https://github.com/eboody/statum) - Statum helps make undesirable state impossible to represent in code, at compile time
   ...
   - [JasterV/teatui](https://github.com/JasterV/teatui) - :warning: This repo has been migrated :warning: Experimental library providing an Elm-like framework to build TUI applications in Rust
   ...
   - [penberg/vsr-rs](https://github.com/penberg/vsr-rs) - Viewstamped Replication (VSR) distributed consensus algorithm implemented in Rust.
...
## <a name="TypeScript"></a>TypeScript
   ...
   - [luxury-yacht/app](https://github.com/luxury-yacht/app) - Luxury Yacht - A cross-platform app for managing Kubernetes clusters and resources
   ...
   - [dcramer/dex](https://github.com/dcramer/dex) - Task tracking for Agents
   - [virattt/dexter](https://github.com/virattt/dexter) - An autonomous agent for deep financial research
   - [dflow-sh/dflow](https://github.com/dflow-sh/dflow) - 
   ...
   - [bruin-data/setup-bruin](https://github.com/bruin-data/setup-bruin) - Official action to install Bruin CLI in Github Actions.
...
## <a name="Zig"></a>Zig
   ...
   - [justrach/openpuffer](https://github.com/justrach/openpuffer) - 
